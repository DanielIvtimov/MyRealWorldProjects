...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'store_email', 'value' => 'store@example.com', 'type' => 'email', 'group' => 'general'],
            ...
            ['key' => 'order_confirmation_email', 'value' => 'order@example.com', 'type' => 'email', 'group' => 'email'],

            // SEO Settings 
            ['key' => 'seo_title', 'value' => 'Best Online Store - Quality Products', 'type' => 'string', 'group' => 'seo'],
            ['key' => 'seo_description', 'value' => 'Shop the best products at great prices. Free shipping on orders over $100.', 'type' => 'text', 'group' => 'seo'],
            ['key' => 'seo_keywords', 'value' => 'online shopping, ecommerce, quality products', 'type' => 'string', 'group' => 'seo'],
        ];
