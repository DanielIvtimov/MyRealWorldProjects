...
class Product extends Model
{
    ...
    {
        $query->where('stock_quantity', '<=', 'low_stock_threshold')->where('stock_quantity', '>', 0);
    }
    ...
    #[Scope()]
    protected function inBrand(Builder $query, int $brandId): void
    {
        $query->where('brand_id', $brandId);
    }
    // Scope to filter by price range
    #[Scope()]
    protected function inPriceRange(Builder $query, float $minPrice, float $maxPrice): void
    {
    ...
    public function getAvarageRatingAttribute()
    {
