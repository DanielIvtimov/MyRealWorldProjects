export const CARD_BG = [
  ...
  { id: 4, bgcolor: 'linear-gradient(135deg, #fff2f9 0%, #fff8f3 100%)' },
  { id: 5, bgcolor: 'linear-gradient(135deg, #e7f6fe 0%, #f4fafd 100%)' },
  { id: 6, bgcolor: 'linear-gradient(135deg, #f5f5f5 0%, #fbfbfd 100%)' },
...
export const API_FEATURES = [
    ...
    },
    {
        ...
        description: "Easily save your interview sets, organize them neatly in our dashboard, and pick up your preparation right where you left off."
    }
]