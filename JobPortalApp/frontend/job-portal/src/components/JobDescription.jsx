  ...
  return (
    <div className='max-w-7xl mx-auto my-10'>
        ...
        <div className='my-4'>
            ...
            <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium.</span></h1>
            ...
            <h1 className='font-bold my-1'>Posted Date: <span className='pl-4 font-normal text-gray-800'>27-08-2025</span></h1>
        </div>
    </div>
  )
}
