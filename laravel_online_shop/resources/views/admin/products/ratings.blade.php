...
@section('content')
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <form action="{{ route('products.productRatings') }}" method="get">
                    <div class="card-header">
                        <a href="{{ route('products.productRatings') }}" class="btn btn-default btn-sm">Reset</a>
...
@section('customJs')
    <script>
        function changeStatus(status, id){
            if(confirm('Are you sure you want to change the status of this rating?')){
