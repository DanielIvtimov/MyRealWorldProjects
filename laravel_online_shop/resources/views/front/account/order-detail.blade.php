                    ...
                    <div class="card">
                        ...
                        <div class="card-footer p-3">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-4 col-md-3 col-xl-2">
                                            ...
                                            @if(!empty($productImage) && !empty($productImage->image))
                                                <img class="img-fluid" src="{{ asset('uploads/product/small/'.$productImage->image)}}" alt="{{ $item->name }}" onerror="this.onerror=null; this.src='{{ asset('admin-assets/img/default-image.png') }}';" />
                                            @else 
                                                <img class="img-fluid" src="{{ asset('admin-assets/img/default-image.png') }}" alt="Default Product Image" />
                                            @endif
                                        </div>
                                        <div class="col">
                                            <!-- Title -->
                            ...
                            <div class="alert alert-info">
                                <p class="mb-0">No order items found.</p>
                            </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="card card-lg mb-5 mt-3">
                        <div class="card-body">
                            ...
                            <ul>
                                ...
                                @if($order->discount > 0)
                                <li class="list-group-item d-flex">
                                    <span>Discount {{ (!empty($order->promo_code)) ? '('.$order->promo_code.')' : 'N/A'}}</span>
